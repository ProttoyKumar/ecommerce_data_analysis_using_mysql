...
-- Calculate bounce rate for the traffic landing on home page
...
FROM
    sessions_w_home_landing_page
        LEFT JOIN
    bounced_sessions ON bounced_sessions.website_session_id = sessions_w_home_landing_page.website_session_id
